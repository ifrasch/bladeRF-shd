...
/**
 * Send SHD params to Nios
 */
API_EXPORT
int CALL_CONV bladerf_shd_send_params(struct bladerf *dev,
									uint32_t frequency,
									uint8_t freq_index);

/**
 * Send SHD control packet to Nios
 */
API_EXPORT
int CALL_CONV bladerf_shd_send_control(struct bladerf *dev,
						bool run,
						uint8_t num_freqs);
