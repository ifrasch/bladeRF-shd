...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "/home/ian/altera/15.0/quartus/"
}
...
alias file_copy {
  echo "\[exec\] file_copy"
  file copy -force $QSYS_SIMDIR/submodules/fft128_fft_ii_0_2n128cos.hex ./
  file copy -force $QSYS_SIMDIR/submodules/fft128_fft_ii_0_1n128sin.hex ./
  file copy -force $QSYS_SIMDIR/submodules/fft128_fft_ii_0_2n128sin.hex ./
  file copy -force $QSYS_SIMDIR/submodules/fft128_fft_ii_0_3n128cos.hex ./
  file copy -force $QSYS_SIMDIR/submodules/fft128_fft_ii_0_3n128sin.hex ./
  file copy -force $QSYS_SIMDIR/submodules/fft128_fft_ii_0_1n128cos.hex ./
}
...
alias com {
  echo "\[exec\] com"
  vcom "$QSYS_SIMDIR/submodules/fft128_fft_ii_0.vho" -work fft_ii_0
  vcom "$QSYS_SIMDIR/fft128.vhd"                                   
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS -L work -L work_lib -L fft_ii_0 -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cycloneive $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS -L work -L work_lib -L fft_ii_0 -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cycloneive $TOP_LEVEL_NAME
}
